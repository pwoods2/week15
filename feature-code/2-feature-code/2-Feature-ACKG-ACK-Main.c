...
//    int D_special; 
	...
	//-------------------------------------------------
	fp = fopen("/Users/pwoods/week15August2024/Input-Files/ACKG-ACK-03262024.txt", "r");
	//-------------------------------------------------
	...
	//-------------------------------------------------
	int ii, jj, pp, qq;
	fpout = fopen("/Users/pwoods/week15August2024/Output-Files/2-Feature-Output/2-Feature-ACKG-ACK-Output.txt", "w");
