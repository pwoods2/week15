...
// this worked 9/11
	//-------------------------------------------------
	fp = fopen("/home/pwoods/week15/4-feature-testing/Test/Input-Files/WT_ACK-300-Genes_2025-01-24.txt", "r");
	//-------------------------------------------------
    ...
    // THIS WORKED 9/11
	int ii, jj, pp, qq;
	fpout = fopen("/home/pwoods/week15/4-feature-testing/Test/4-Feature-WT-ACK-Test-300-Output.txt", "w");
