...
// this worked 9/11
	//-------------------------------------------------
	fp = fopen("/Users/pwoods/week15August2024/4-Feature-Testing/WT_ACK-TestOct2024.txt", "r");
	//-------------------------------------------------
    ...
    // THIS WORKED 9/11
	int ii, jj, pp, qq;
	fpout = fopen("/Users/pwoods/week15August2024/4-Feature-Testing/4-Feature-WT-ACK-TestOutput.txt", "w");
