...
feature.1 <- read.csv("Output-Files/1-Feature-Output/1-Feature-WT-ACK-Output.txt",sep = "\t")[,-c(2:4)]
feature.2 <- read.csv("Output-Files/2-Feature-Output/2-Feature-WT-ACK-Output.txt",sep = "\t")[,-c(2:4)]
feature.3 <- read.csv("Output-Files/3-Feature-Output/3-Feature-WT-ACK-Output.txt",sep = "\t")[,-c(2:4)]
...
write.csv(feature.1.annotation, file="Calculation-Output/1-Feature-WT-ACK-Calculation.csv",row.names=FALSE)

## Save 2 feature annotated results
write.csv(feature.2.annotation, file="Calculation-Output/2-Feature-WT-ACK-Calculation.csv",row.names=FALSE)

## Save 3 feature annotated results
write.csv(feature.3.annotation, file="Calculation-Output/3-Feature-WT-ACK-Calculation.csv",row.names=FALSE)
