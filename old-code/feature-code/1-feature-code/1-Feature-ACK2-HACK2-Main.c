...
//    int D_special; 
	...
	//-------------------------------------------------
	fp = fopen("/Users/pwoods/week15August2024/Input-Files/ACK2-HACK2-03202024.txt", "r");
    ...
    // THIS WORKED 9/11
	int ii, jj, pp, qq;
	fpout = fopen("/Users/pwoods/week15August2024/Output-Files/1-Feature-Output/1-Feature-ACK2-HACK2-Output.txt", "w");
