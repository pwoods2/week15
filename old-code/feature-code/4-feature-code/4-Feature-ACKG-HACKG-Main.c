...
// this worked 9/11
	//-------------------------------------------------
	fp = fopen("/Users/pwoods/week15August2024/Input-Files/ACKG-HACKG-03262024.txt", "r");
	//-------------------------------------------------
	...
	//-------------------------------------------------
	int ii, jj, pp, qq;
	fpout = fopen("/Users/pwoods/week15August2024/Output-Files/3-Feature-Output/3-Feature-ACKG-HACKG-Output.txt", "w");
