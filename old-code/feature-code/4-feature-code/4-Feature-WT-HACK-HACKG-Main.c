...
// this worked 9/11
	//-------------------------------------------------
	fp = fopen("/Users/pwoods/week15August2024/Input-Files/WT_HACK-HACKG-03202024.txt", "r");
	//-------------------------------------------------
    ...
    // THIS WORKED 9/11
	int ii, jj, pp, qq;
	fpout = fopen("/Users/pwoods/week15August2024/Output-Files/3-Feature-Output/3-Feature-WT-HACK-HACKG-Output.txt", "w");
