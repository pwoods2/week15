...
read -p "Enter the specific main.c file to use (e.g., 2-Feature-WT-ACK-Main.c): " main_file

# Prompt the user for input of the output binary name
read -p "Enter the name of the output binary (e.g., 2-Feat-WT-ACK): " output

# Define the directory where the .c files are located
source_dir="/Users/pwoods/week15August2024/Feature-Code/2-Feature-Code"  # Replace with the actual directory
